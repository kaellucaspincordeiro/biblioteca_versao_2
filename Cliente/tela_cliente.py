...
# --- BOTÃO VOLTAR ---
    ...
    tk.Label(frame_cliente, text="Status:", font=("Arial", 10, "bold")).grid(row=10, column=0, pady=(0, 2))
    ...
    combo_status.grid(row=11, column=0, pady=(0, 5))
    ...
    def salvar_cliente():
        ...
        if condicao_cliente:
            bd.db_cadastrar_cliente(nome_cliente, telefone, endereco, cpf, status)
    ...
    tk.Button(frame_cliente, text="Cadastrar cliente", command=salvar_cliente, bg="green", fg="white").grid(row=12, column=0, pady=(0, 15))

    # --- Lista de Livros ---
    tk.Label(frame_cliente, text="Clientes Cadastrados:", font=("Arial", 10, "bold")).grid(row=13, column=0, pady=(0, 10))
    ...
    tabela = ttk.Treeview(
        frame_tabela,
        columns=("id", "cliente", "telefone", "endereço", "cpf", "status"),
        show="headings",
    ...
    def atualizar_lista():
        ...
        for cli in clientes:           
            tabela.insert("", "end", values=(cli[0],cli[1],cli[2],cli[3],cli[4],cli[5]))
    ...
    def atualizar_cliente():
        ...
        tk.Label(janela_cliente, text="Status:").grid(row=8, column=0, pady=5)
        combo_status = ttk.Combobox(
        janela_cliente,
        values=["Aluno","Professor"],
        width=37,
        ...
        combo_status.grid(row=9, column=0, pady=5)
        ...
        def salvar_atualizacao():
                ...
                bd.db_atualizar_cliente(id_cli, nome, telefone, endereco, cpf, status)
                messagebox.showinfo("Sucesso", "Cliente atualizada com sucesso!")
